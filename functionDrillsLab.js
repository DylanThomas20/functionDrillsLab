...
// let jsNinja = () => {
//   return 'I am a JavaSciprt ninja!'
// }
// console.log(jsNinja())
...
// console.log(printName('Dylan Thomas'))
...
// const name = (sampleString) => sampleString.toUpperCase()
...
*/
// let email = 'dtsports17@gmail.com'
...
function goldFrogBuyer(goldAmount){
    frogAmount = 0
  for(let i = 0; i < goldAmount; i + 3){
    if(goldAmount >= 3){
      frogAmount ++
      goldAmount -= 3
    } else {
      return `You have purchased ${frogAmount} chocolate frogs! You have ${goldAmount} gold pieces left over.`
    }
  }
}
console.log(goldFrogBuyer(goldAmount))
